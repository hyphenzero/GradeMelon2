...
import { BsGear, BsQuestionLg, BsTable } from 'react-icons/bs'
...
const itemBase =
  'flex items-center gap-3 rounded-2xl px-3 py-2 text-sm font-medium text-zinc-700 transition data-hover:bg-zinc-950/5 dark:text-zinc-200 dark:data-hover:bg-white/5'
    ...
    <div className="flex w-fit flex-col items-center">
      <div className="sticky top-16 hidden h-full w-fit max-w-min py-8 pl-8 md:block">
        <aside className="w-64" aria-label="Sidebar">
          <div className="space-y-1 rounded-3xl border border-zinc-200/80 bg-white/90 p-3 shadow-sm shadow-zinc-950/5 dark:border-white/10 dark:bg-zinc-900/80">
        ...
        {router.pathname.includes('grades') && (
          <div className="max-w-70 mt-4 hidden shrink md:block">
